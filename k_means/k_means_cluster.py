...
print ("Minimum stock value using MinMaxScaler :", min(exercised_stock_options))
print ("Maximum stock value using MinMaxScaler:", max(exercised_stock_options))

print ("Minimum salary value using MinMaxScaler:", min(salary))
print ("Maximum salary value usingMin MaxScaler:", max(salary))
